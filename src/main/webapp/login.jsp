...
<head>
    ...
    <title>Login - SecureCare</title>
    <link rel="stylesheet" href="css/styles.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</head>
<body class="cyber-bg" style="display: flex; align-items: center; justify-content: center;">
    ...
    <div class="glass-panel fade-in" style="width: 100%; max-width: 450px;">
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h2>Welcome Back</h2>
            <p style="color: var(--secondary);">Login to access your secure portal</p>
        </div>
        ...
        <form action="login" method="POST">
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 1rem;">
                Secure Login <i class="fa-solid fa-arrow-right-to-bracket" style="margin-left: 8px;"></i>
            </button>
        </form>
        
        <p style="text-align: center; margin-top: 1.5rem; font-size: 0.9rem;">
            Don't have an account? <a href="register.jsp" style="color: var(--highlight); text-decoration: none; font-weight: 600;">Register here</a>
        </p>
    </div>
